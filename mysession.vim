...
badd +37 srcs/get_t_minishell.c
badd +18 srcs/get_env_paths.c
badd +24 srcs/run.c
badd +6 srcs/get_bin_paths.c
badd +1 libft/srcs
badd +22 srcs/get_argv.c
badd +0 libft/srcs/ft_strdup.c
badd +1 libft/srcs/ft_count_words.c
badd +0 srcs/clear.c
argglobal
silent! argdel *
...
silent! normal! zE
let s:l = 52 - ((39 * winheight(0) + 25) / 50)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 13 - ((9 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
13
