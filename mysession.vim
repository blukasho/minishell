...
badd +22 srcs/expansions.c
badd +14 Makefile
badd +57 srcs/manage_tilda.c
badd +16 includes/minishell.h
...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 96 + 131) / 263)
exe 'vert 2resize ' . ((&columns * 166 + 131) / 263)
argglobal
3argu
