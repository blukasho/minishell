...
badd +20 srcs/manage_tilda.c
badd +1 libft
badd +1 libft/srcs/ft_strcmp.c
...
silent! normal! zE
let s:l = 38 - ((25 * winheight(0) + 25) / 50)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 22 - ((13 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 44 - ((42 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 19 - ((12 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 95 + 96) / 193)
